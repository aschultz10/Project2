...
// ToDo Write code for charts here:
...
//   })
// }
//Extract info from csv file(s)

import Papa from "https://cdn.skypack.dev/papaparse@5.3.0";
let fileInput = document.getElementById("income").files[0]Papa.parse(file,
    {
...
//     //WHAT TYPE OF FILE DO WE IMPORT TO GET THE DATA TO PLOT??
//     d3.json("../data/samples.json").then((data)=> {
//         //console.log(data)
//     //});
        
//         // Filter country values by name 
//         var countryx = data.samples.filter(s => s.id.toString() === id)[0];
...
//  //example of multi trace       
// //trace1 for Greek data
// var trace1 = {
//     //"pair" and "greekSearchResults" are from the data.js file
...
// var layout = {
//     title: "Greek vs. Roman gods searxh results",
//     barmode: "group"
// };
